...
DEFAULT_RAMP_UP_TIME = 15.0  # Seconds — stability window before allowing current increase
DEFAULT_RAMP_UP_STEP = 4.0   # Amps — current increase per stability period
...
MAX_RAMP_UP_STEP = 32.0  # Amps — maximum step size
