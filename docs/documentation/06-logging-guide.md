...
The integration exposes a **Balancer state** diagnostic sensor (`sensor.*_balancer_state`) that shows the current operational state. This maps to the charger state machine described in the [How It Works](02-how-it-works.md#balancer-states) guide:
