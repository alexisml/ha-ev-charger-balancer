...
| Event notifications | PR-5-MVP | alexisml | +8 days | HA events + persistent notifications for fault conditions | |
| Manual override + observability | PR-6-MVP | alexisml | +10 days | `ev_lb.set_limit` service + diagnostic state | |
| Test stabilization + HACS release | PR-7-MVP | alexisml | +12 days | Full integration tests, HACS-ready release | |
