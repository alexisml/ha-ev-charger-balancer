...
This document contains the implementation roadmap.  It was split out from [`2026-02-19-research-plan.md`](2026-02-19-research-plan.md) so the delivery phases are clearly separated.
